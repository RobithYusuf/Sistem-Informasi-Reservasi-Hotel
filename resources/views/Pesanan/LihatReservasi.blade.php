                ...
                <table style='width:100%; font-size:8pt; font-family:calibri; border-collapse: collapse;' border='0'>
                    <tr>
                        ...
                        <td width='30%' align='left' style='vertical-align:top'>
                            ...
                            Kode Reservasi : <span style="border-bottom: 1px solid red;">{{ $reservasi->kode_reservasi }}</span><br>
                            Tanggal : {{ $reservasi->created_at->format('d F Y') }}<br>
                            Jumlah Kamar : {{ $reservasi->jumlah_kamar }}
                        </td>
                    </tr>
                </table>
                ...
                <table style='width:100%; font-size:8pt; font-family:calibri; border-collapse: collapse; margin-top: 10px; margin-bottom: 10px;' border='0'>
                    <tr>
                        <td width='30%' align='left' style='padding-right:80px; vertical-align:top'>
                            Nama Pelanggan : {{ $reservasi->nama_tamu }}<br>
                            No Telp : {{ $reservasi->no_hp }}
                        </td>
                    </tr>
                </table>
                ...
                <div class="table-responsive" style="margin-top: -10px;">
                    <table cellspacing='0' style='width:100%; font-size:8pt; font-family:calibri; border-collapse: collapse;' border='1' class="detailsRes mt-3">
                        ...
                        <tr align='center' style="background-color: #ffffff;">
                            <td style="border: 1px solid black;">{{ $reservasi->jenis_kamar }}</td>
                            <td style="border: 1px solid black;">{{ 'Rp ' . number_format($reservasi->harga, 0, ',', '.') }}</td>
                            <td style="border: 1px solid black;">{{ \Carbon\Carbon::parse($reservasi->checkIn)->format('d M Y') }}</td>
                            <td style="border: 1px solid black;">{{ \Carbon\Carbon::parse($reservasi->checkOut)->format('d M Y') }}</td>
